...
from custom_timm.models._features import FeatureListNet, FeatureDictNet, FeatureHookNet, FeatureGetterNet
...
def build_model_with_cfg(
    ...
    """
    # print('---- entered build with config ----')
    ...
    if features:
        ...
        # print('---- exit build with config in loop ----')
